...
data_arg.add_argument('--city_num', type=int, default=15, help='city num')  # 城市数量，对应于问题的规模
data_arg.add_argument('--pos_dimension', type=int, default=2, help='city num')  # 坐标维度，横纵坐标，二维
data_arg.add_argument('--individual_num', type=int, default=60, help='individual num')  # 个体数
data_arg.add_argument('--gen_num', type=int, default=400, help='generation num')  # 迭代轮数和城市数量和坐标维度相关的
